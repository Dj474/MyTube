...
public class KafkaConsumerService {
    ...
    @KafkaListener(topics = "video-upload-topic", groupId = "video-processor-group", containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "user-subscription-topic", groupId = "video-processor-group", containerFactory = "kafkaListenerSubscriptionContainerFactory")
