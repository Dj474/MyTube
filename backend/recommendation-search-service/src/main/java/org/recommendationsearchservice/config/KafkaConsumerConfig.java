...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, VideoRecord> consumerVideoFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, VideoRecord.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, VideoRecord> kafkaListenerContainerVideoFactory() {
        ...
        factory.setConsumerFactory(consumerVideoFactory());
    ...
    @Bean
    public ConsumerFactory<String, UserRecord> consumerUserFactory() {
        Map<String, Object> props = new HashMap<>();
        ...
        // Указываем в какой класс превращать JSON (полное имя класса)
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, UserRecord.class);
